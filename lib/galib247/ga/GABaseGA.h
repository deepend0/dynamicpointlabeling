...
public:
  ...
  virtual int nGenerations() const {return ngen;}
  ...
  GAGenome::SexualCrossoverFn crossover(GAGenome::SexualCrossoverFn f)
    {return scross=f;}
  GAGenome::SexualCrossoverFn sexual() const {return scross;}
  ...
  virtual void objectiveFunction(GAGenome::EvaluatorFn f);
...
protected:
  ...
  float pmut;
  int minmax;
  GAGenome::SexualCrossoverFn scross;	// sexual crossover to use
