...
public:
  ...
  typedef std::function<Evaluator> EvaluatorFn;
  ...
  typedef int   SexualCrossover(const GAGenome&, const GAGenome&,
				   GAGenome*, GAGenome*);
  typedef std::function<SexualCrossover> SexualCrossoverFn;
...
public:
  ...
  EvaluatorFn evaluator() const {return eval;}
  EvaluatorFn evaluator(EvaluatorFn f) { _evaluated=gaFalse; return(eval=f); }
  ...
  SexualCrossoverFn crossover(SexualCrossoverFn f) { return sexcross = f; }
  SexualCrossoverFn sexual() const { return sexcross; }
...
protected:
  ...
  EvaluatorFn eval;		// objective function
  ...
  SexualCrossoverFn sexcross;	// preferred sexual mating method
